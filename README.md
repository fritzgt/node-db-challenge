...
Relational Databases are a type of databases and SQL is a way to communicate with the database.

- [x] Why do tables need a `primary key`?

For data normalization we need the it because the primary key is used to identify the entry/row so we can manipulate the data easily.
